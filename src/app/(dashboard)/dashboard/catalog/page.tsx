...
import { SKILLS_TAXONOMY, SKILL_CATEGORIES } from "@/data/skills-taxonomy";
import { ENGINE_TYPE_LABELS } from "@/types";
  ...
  return (
    <div style={{ maxWidth: 960 }}>
      ...
      <section style={{ marginBottom: "var(--stack-md)" }}>
        ...
        <p className="body-sm">
          Explore {SKILLS_TAXONOMY.length} core capabilities. Choose a skill, then start a sub-skill sprint.
        </p>
      </section>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {filteredSkills.map((skill) => {
          ...
          return (
            <div key={skill.name} className="card" style={{ padding: 0 }}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="body-sm" style={{ fontSize: 11, flexShrink: 0 }}>
                          {"●".repeat(sub.difficulty_level)}
                          {"○".repeat(5 - sub.difficulty_level)}
                        </div>
      ...
      {filteredSkills.length === 0 && (
        <div className="empty-state" style={{ padding: "var(--stack-lg)" }}>
          <div className="empty-state-icon" style={{ fontSize: 40 }}>
            🔍
          </div>
          <div className="empty-state-title">No skills found</div>
          <div className="empty-state-text">
            Try adjusting your search or filter to find skills.
          </div>
          <button
